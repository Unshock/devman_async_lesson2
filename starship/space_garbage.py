...
async def fill_orbit_with_garbage(canvas, garbage_coroutines=GARBAGE_COROUTINES):
    garbage_frames = [
    ...
    while True:
        ...
        frame_path = choice(garbage_frames)
        ...
        random_sleep = randint(10, 40)
        for tic in range(random_sleep):
            await asyncio.sleep(0)
